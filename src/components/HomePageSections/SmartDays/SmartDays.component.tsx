...
export const SmartDays = () => {
  return (
    <div className="py-24 bg-gradient-to-br from-indigo-500 via-primary-500zz to-primary-500">
      <div className="pack-content w-full flex flex-col gap-8">
        <div className="flex items-start flex-col gap-12">
          <span className="text-[clamp(28px,6vw,40px)] font-extrabold dark:font-boldzz text-white text-slate-800zzdark:text-white">
            {"Colors With Purpose"}
          </span>
          ...
          <div className="text-[clamp(16px,5vw,24px)] text-slate-400zzdark:text-neutral-600 text-white/60">
            {
          ...
          <div className="text-[clamp(16px,5vw,24px)] italic text-slate-400zzdark:text-neutral-600 text-white/60 flex flex-wrap items-center">
            <span className="mr-2">
